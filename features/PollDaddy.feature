...
Given I am on the opinion page of the stage version of a USCP site
Then I can see the word 'POLL' in the left suspender
  And I can see the PollDaddy module
...
Given I am on the 'Your Say' page for a poll
When I click on the 'View Results' link
Then I can see the results of the poll
